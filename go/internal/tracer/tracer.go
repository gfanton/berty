...
const (
	ExporterType_None ExporterType = iota
	ExporterType_Stdout
	ExporterType_Jaeger
)
...
func InitTracer(flag, service string) func() {
	...
	case "": // None
		return func() {}
	case "stdout": // Stdout
		cfg.ExporterType = ExporterType_Stdout
	default: // Jaeger
		cfg.ExporterType = ExporterType_Jaeger
		cfg.JaegerHost = flag
	}
